...
revenue.AddRevenue = Ext.extend(Ext.form.Panel,{
	fromedit : false, 
	width : 490,
	height : 500 ,
	fromWin : null,
	...
	setLoadData : function(record){
		...
		groupId = record.data.revenue_list;
     	if(groupId != 0){ 
     		if(this.currentRecord == null  || groupId != this.currentRecord.data.revenue_list){ 
	...
	initComponent: function( ) {
		...
		main.revenueId = new Ext.form.field.Hidden({
			name : 'revenue_id',
			anchor:'100%',
			value : ''
		});
		...
		revenue.AddRevenue.superclass.initComponent.apply(this, arguments);
	}
